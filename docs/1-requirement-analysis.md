...
|NFR-07| 확장성        | 추후 알림 기능, 댓글 기능, 일정 좋아요 기능 등을 추가할 수 있도록 설계한다.  |
|NFR-08| 호환성        | Apache Tomcat 환경에서 실행 가능하도록 JSP / Servlet 기반으로 구현한다.      |
...
| ---------- | -------------------------------------------------- | :----------: | ---------------- | ----------------------------------- |
| `NF-01`  | `[NF-01] Maven 웹 프로젝트 기본 구조 생성`       |     높음     | 김용민         |    `NFR-06`, `NFR-07`, `NFR-08`          |
| `NF-02`  | `[NF-02] MySQL 데이터베이스 및 JDBC 연결 설정`   |     높음     | 김용민         | `NFR-03`, `NFR-05`, `NFR-08`     |
| `NF-03`  | `[NF-03] 공통 레이아웃 및 정적 리소스 구조 구성` |     중간     | 김준섭         | `NFR-01`, `NFR-02`, `NFR-06`, `NFR-08`         |
...
| `F-06`   | `[F-06] Kakao Map API 연동 및 위치 정보 저장`    |     중간     | 김용민, 김준섭 | `FR-12`, `NFR-01`, `NFR-05`, `NFR-08`                   |
