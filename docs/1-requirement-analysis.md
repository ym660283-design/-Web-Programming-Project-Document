...
| 구분            | ID 형식  | 설명                                 |
| ----------------- | ---------- | -------------------------------------- |
| 기능적 요구사항 | `F-번호` | 사용자가 직접 이용하는 기능 요구사항 |
| 그 외 요구사항 | `NF-번호` | 보안, 사용성, 유지보수성 등 품질 요구사항
...
| ---------- | -------------------------------------------------- | :----------: | ---------------- | ----------------------------------- |
| `NF-01`  | `[NF-01] Maven 웹 프로젝트 기본 구조 생성`       |     높음     | 김용민         | `NF-03`                           |
| `NF-02`  | `[NF-02] MySQL 데이터베이스 및 JDBC 연결 설정`   |     높음     | 김용민         | `NF-04`, `NF-05`                  |
| `NF-03`  | `[NF-03] 공통 레이아웃 및 정적 리소스 구조 구성` |     중간     | 김준섭         | `NF-01`, `NF-03`                  |
| `F-01`   | `[F-01] 회원가입 화면 및 기능 구현`              |    높음      | 김용민, 김준섭 | `F-01`, `NF-01`, `NF-04`          |
| `F-02`   | `[F-02] 로그인 및 로그아웃 기능 구현`            |     높음     | 김용민         | `F-02`, `NF-02`                   |
| `F-03`   | `[F-03] 여행 일정 목록 및 생성 화면 구현`        |     높음     | 김준섭         | `F-03`, `NF-01`                   |
| `F-04`   | `[F-04] 여행 일정 CRUD 기능 구현`                |    높음      | 김용민         | `F-03`, `NF-02`, `NF-04`, `NF-05` |
| `F-05`   | `[F-05] 날짜별 세부 일정 화면 및 CRUD 구현`      |     높음     | 김용민, 김준섭 | `F-04`, `NF-04`, `NF-05`          |
| `F-06`   | `[F-06] Kakao Map API 연동 및 위치 정보 저장`    |     중간     | 김용민, 김준섭 | `F-05`, `NF-01`                   |
| `F-07`   | `[F-07] 공유 링크 및 참여자 관리 기능 구현`      |     중간     | 김용민, 김준섭 | `F-06`, `F-07`, `NF-02`, `NF-04`  |
